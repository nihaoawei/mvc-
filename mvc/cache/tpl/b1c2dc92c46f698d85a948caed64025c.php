...
<div class="fatie_top" style="margin: 0 20px;">
		...
		<div style="margin: 0  20px;" class="fatie_content clearFix">
			<form action="index.php?m=fatie&a=doFatie" method="post" enctype="multipart/form-data">
				英雄图片：<input  type="file" name="tupian" /><br/>
                英雄名字：<input class="inp"  type="text" name="yname" value="" class="content" /><br />
				英雄介绍：<input class="inp"  type="text" name="title" value="" class="content" />
