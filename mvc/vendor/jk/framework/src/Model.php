...
class Model
{
	...
	public function max($fields)
	{
		...
		$sql = "SELECT MAX($fields) as m FROM " .$this->parseTable() .' '.$this->parseWhere();
		//echo $sql;
		$data = $this->query($sql);
	...
	public function min($fields)
	{
		...
		$sql = "SELECT MIN($fields) as m FROM " .$this->parseTable() .' '.$this->parseWhere();
		//echo $sql;
		$data = $this->query($sql);
	...
	public function sum($fields)
	{
		...
		$sql = "SELECT SUM($fields) as m FROM  ".$this->parseTable() .' '.$this->parseWhere();
		//echo $sql;
		$data = $this->query($sql);
	...
	public function count($fields)
	{
		...
		$sql = "SELECT COUNT($fields) as m FROM  ".$this->parseTable() .' '.$this->parseWhere();
		//echo $sql;
		$data = $this->query($sql);
	...
	public function avg($fields)
	{
		...
		$sql = "SELECT AVG($fields) as m FROM " .$this->parseTable() .' '.$this->parseWhere();
		//echo $sql;
		$data = $this->query($sql);
